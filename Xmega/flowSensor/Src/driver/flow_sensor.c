...
void get_flow1_value(void)
{
  if (get_timer_value() - flowTimer >= FLOW_REFRESH_TIME)
  {
    ...
    flow1 = (((FLOW_REFRESH_TIME / (get_timer_value() - flowTimer)) * flow1Ticks) / CALIBRATION_FACTOR)/60*1000;
